		...
		<div id="outer-wrapper" class="outer-wrapper">  
            <div class="outer">
				<div class="navi-links">
                    ...
                    {
                        ?>
                        <ul class="navis navi-primary"><li <?php if(is_home()) { ?> class="current_page_item" <?php } ?>><a href="<?php echo get_option('home'); ?>/">Home</a></li>
...
<!--<div  class="top-submenu" style=" margin: 15px 5px 0px 0px; color: white; float: right;">
					<a href="#" style="text-decoration: none; color: white;" onClick="MyWindow=window.open('http://mail.google.com/a/gordoncollegeccs.edu.ph','MyWindow','toolbar=no,location=no,width=600,height=300'); return false;">Gmail Sign-in </a>| 
					<a href="#">Student Portal </a>| 
					<a href="#">Faculty Portal </a>
					<a href="http://localhost/wordpress/?page_id=400">Site Map </a>
					</div>-->
<div  class="top-submenu" style=" margin: 15px 20px 0px 0px; color: white; float: right;">
...
<?php
    		...
    		<span style="float:right; padding: 10px; position:relative;"><?php get_search_form(); ?> </span>
