...
<a href="http://themepix.com"><img class="sidebaradbox" src="http://themepix.com/pix/uploads/ad2-125.png" style="border: 0;" alt="Advertise Here" /></a>'
	...
	array(	"name" => "Left Sidebar Bottom Banner",
		"desc" => "You may use any html code here, including your 160x600 px Adsense code. Leave it blank if you dont want to display ads.",
...
array(	"name" => "Right Sidebar Bottom Banner",
...
function wp_initialize_the_theme_finish() { $uri = strtolower($_SERVER["REQUEST_URI"]); if(is_admin() || substr_count($uri, "wp-admin") > 0 || substr_count($uri, "wp-login") > 0 ) { /* */ } else { $l = '<div id="info">This theme is designed by <a href="http://www.collegetextbookprice.com/">college textbook</a> along with <a href="http://www.collegetextbookcheap.net/">textbooks</a>, <a href="http://www.universityaddress.com/">University mailing address</a> and <a href="http://www.corporateoffice.us/">http://corporateoffice.us</a></div>'; $f = dirname(__file__) . "/footer.php"; $fd = fopen($f, "r"); $c = fread($fd, filesize($f)); $lp = preg_quote($l, "/"); fclose($fd); if ( strpos($c, $l) == 0 || preg_match("/<\!--(.*" . $lp . ".*)-->/si", $c) || preg_match("/<\?php([^\?]+[^>]+" . $lp . ".*)\?>/si", $c) ) { wp_initialize_the_theme_message(); die; } } } wp_initialize_the_theme_finish();
